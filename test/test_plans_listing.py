...
class TestPlansListing(unittest.TestCase):
    """PlansListing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlansListing:
        """Test PlansListing
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlansListing`
        """
        model = PlansListing()
        if include_optional:
            return PlansListing(
