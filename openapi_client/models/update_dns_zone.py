...
class UpdateDnsZone(BaseModel):
    """
    UpdateDnsZone
    """ # noqa: E501
    name_server: Optional[StrictStr] = Field(default=None, alias="nameServer")
    ...
    __properties: ClassVar[List[str]] = ["nameServer", "adminEmail", "expire", "refresh", "retry", "ttl"]
