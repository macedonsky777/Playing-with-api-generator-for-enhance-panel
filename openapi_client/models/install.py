...
class Install(BaseModel):
    ...
    accept_terms: Optional[StrictBool] = Field(default=None, alias="acceptTerms")
    locale: CPLocale
    __properties: ClassVar[List[str]] = ["owner", "orgName", "acceptTerms", "locale"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owner": LoginInfo.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
