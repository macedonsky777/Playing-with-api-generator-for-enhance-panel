...
class ImportServerDomain(BaseModel):
    """
    ImportServerDomain
    """ # noqa: E501
    import_server_id: StrictStr = Field(alias="importServerId")
    domain: StrictStr
    kind: DomainMappingKind
    user: StrictStr
    movable: StrictBool
    __properties: ClassVar[List[str]] = ["importServerId", "domain", "kind", "user", "movable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "importServerId": obj.get("importServerId"),
