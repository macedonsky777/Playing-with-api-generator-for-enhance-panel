...
class WpInstallation(BaseModel):
    """
    WpInstallation
    """ # noqa: E501
    db_name: StrictStr = Field(alias="dbName")
    db_user: StrictStr = Field(alias="dbUser")
    table_prefix: StrictStr = Field(alias="tablePrefix")
    path: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["dbName", "dbUser", "tablePrefix", "path"]
