...
class ValidatedPasswordRecovery(BaseModel):
    """
    ValidatedPasswordRecovery
    """ # noqa: E501
    obfuscated_email: Optional[StrictStr] = Field(default=None, alias="obfuscatedEmail")
    __properties: ClassVar[List[str]] = ["obfuscatedEmail"]
