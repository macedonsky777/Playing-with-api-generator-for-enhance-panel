...
class ServerHostnameWebsite(BaseModel):
    """
    ServerHostnameWebsite
    """ # noqa: E501
    website_id: StrictStr = Field(alias="websiteId")
    domains: List[DomainWithUuid]
    __properties: ClassVar[List[str]] = ["websiteId", "domains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domains": [DomainWithUuid.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
