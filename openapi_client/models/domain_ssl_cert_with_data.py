...
class DomainSslCertWithData(BaseModel):
    """
    ...
    cert: StrictStr
    key: StrictStr
    force_https: Optional[StrictBool] = Field(default=None, alias="forceHttps")
    __properties: ClassVar[List[str]] = ["cn", "expires", "issued", "issuer", "sans", "cert", "key", "forceHttps"]
