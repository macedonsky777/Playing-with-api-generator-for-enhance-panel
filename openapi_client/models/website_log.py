...
class WebsiteLog(BaseModel):
    ...
    metadata: Optional[WebsiteLogMetadata] = None
    __properties: ClassVar[List[str]] = ["createdAt", "status", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": WebsiteLogMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
