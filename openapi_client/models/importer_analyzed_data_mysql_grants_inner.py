...
class ImporterAnalyzedDataMysqlGrantsInner(BaseModel):
    """
    ...
    privilege: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["dbName", "username", "tableName", "privilege"]
