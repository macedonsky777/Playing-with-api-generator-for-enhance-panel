...
class ResourceCheckError(BaseModel):
    """
    ResourceCheckError
    """ # noqa: E501
    conflicts: Optional[List[ResourceCheckConflict]] = None
    resources: Optional[List[ResourceCheckManagerError]] = None
    __properties: ClassVar[List[str]] = ["conflicts", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conflicts": [ResourceCheckConflict.from_dict(_item) for _item in obj["conflicts"]] if obj.get("conflicts") is not None else None,
            "resources": [ResourceCheckManagerError.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
