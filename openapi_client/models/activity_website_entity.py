...
class ActivityWebsiteEntity(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['website']):
            raise ValueError("must be one of enum values ('website')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "content": ActivityWebsiteEntityContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
