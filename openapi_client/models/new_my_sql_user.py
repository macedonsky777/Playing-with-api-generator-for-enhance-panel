...
class NewMySQLUser(BaseModel):
    """
    NewMySQLUser
    """ # noqa: E501
    username: StrictStr
    password: StrictStr
    auth_plugin: Optional[MySQLAuthPlugin] = Field(default=None, alias="authPlugin")
    __properties: ClassVar[List[str]] = ["username", "password", "authPlugin"]
