...
class ActivityServerEntityContentDetail(BaseModel):
    """
    ActivityServerEntityContentDetail
    """ # noqa: E501
    ok: Optional[ActivityServerEntityDetail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": ActivityServerEntityDetail.from_dict(obj["ok"]) if obj.get("ok") is not None else None,
