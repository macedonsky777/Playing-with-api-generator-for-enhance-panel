...
class ServiceLog(BaseModel):
    ...
    service_kind: DaemonKind = Field(alias="serviceKind")
    status: ServiceLogStatus
    metadata: Optional[ServiceLogMetadata] = None
    __properties: ClassVar[List[str]] = ["createdAt", "serviceKind", "status", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ServiceLogMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
