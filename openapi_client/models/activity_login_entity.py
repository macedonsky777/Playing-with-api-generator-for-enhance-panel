...
class ActivityLoginEntity(BaseModel):
    """
    ActivityLoginEntity
    """ # noqa: E501
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['login']):
            raise ValueError("must be one of enum values ('login')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "content": ActivityLoginEntityContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
