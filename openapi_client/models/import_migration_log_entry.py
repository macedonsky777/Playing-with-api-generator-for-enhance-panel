...
class ImportMigrationLogEntry(BaseModel):
    """
    ImportMigrationLogEntry
    """ # noqa: E501
    id: StrictStr
    created_at: StrictStr = Field(alias="createdAt")
    migration_id: StrictStr = Field(alias="migrationId")
    log_data: StrictStr = Field(alias="logData")
    percentage_complete: StrictInt = Field(alias="percentageComplete")
    level: LogLevel
    action: LogAction
    kind: LogKind
    __properties: ClassVar[List[str]] = ["id", "createdAt", "migrationId", "logData", "percentageComplete", "level", "action", "kind"]
