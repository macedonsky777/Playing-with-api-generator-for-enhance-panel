...
class ServersListing(BaseModel):
    """
    ServersListing
    """ # noqa: E501
    items: List[ServerInfoBrief]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ServerInfoBrief.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
