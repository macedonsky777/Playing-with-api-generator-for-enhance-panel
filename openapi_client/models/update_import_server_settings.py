...
class UpdateImportServerSettings(BaseModel):
    """
    ...
    ssh_public_key: Optional[StrictStr] = Field(default=None, alias="sshPublicKey")
    ssh_private_key: Optional[StrictStr] = Field(default=None, alias="sshPrivateKey")
    import_type: Optional[ImportKind] = Field(default=None, alias="importType")
    auth_kind: Optional[ServerMigrationSettingsAuthType] = Field(default=None, alias="authKind")
    auth_user: Optional[StrictStr] = Field(default=None, alias="authUser")
    ssh_port: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="sshPort")
    api_port: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="apiPort")
    allow_partial_sync: Optional[StrictBool] = Field(default=None, alias="allowPartialSync")
    __properties: ClassVar[List[str]] = ["hostname", "friendlyName", "sshUser", "sshPublicKey", "sshPrivateKey", "importType", "authKind", "authUser", "sshPort", "apiPort", "allowPartialSync"]
