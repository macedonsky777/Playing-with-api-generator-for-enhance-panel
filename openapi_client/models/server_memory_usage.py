...
class ServerMemoryUsage(BaseModel):
    ...
    ram: SpaceUsage
    swap: SpaceUsage
    __properties: ClassVar[List[str]] = ["ram", "swap"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ram": SpaceUsage.from_dict(obj["ram"]) if obj.get("ram") is not None else None,
            "swap": SpaceUsage.from_dict(obj["swap"]) if obj.get("swap") is not None else None
        })
        return _obj
