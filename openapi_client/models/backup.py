...
class Backup(BaseModel):
    ...
    mysql_dbs_count: Optional[StrictInt] = Field(default=None, alias="mysqlDbsCount")
    ...
    emails_count: Optional[StrictInt] = Field(default=None, alias="emailsCount")
    ...
    __properties: ClassVar[List[str]] = ["id", "websiteId", "startedAt", "finishedAt", "snapshotDirName", "size", "homeDirStatus", "filesSize", "mysqlDbsStatus", "mysqlDbsCount", "mysqlDbsSize", "emailsStatus", "emailsCount", "emailsSize", "kind", "description", "storageKind"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mysqlDbsCount": obj.get("mysqlDbsCount"),
            "mysqlDbsSize": obj.get("mysqlDbsSize"),
            "emailsStatus": obj.get("emailsStatus"),
            "emailsCount": obj.get("emailsCount"),
