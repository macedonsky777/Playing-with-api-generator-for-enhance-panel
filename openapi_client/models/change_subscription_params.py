...
class ChangeSubscriptionParams(BaseModel):
    """
    ChangeSubscriptionParams
    """ # noqa: E501
    subscription_id: ChangeSubscriptionParamsSubscriptionId = Field(alias="subscriptionId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptionId": ChangeSubscriptionParamsSubscriptionId.from_dict(obj["subscriptionId"]) if obj.get("subscriptionId") is not None else None
        })
        return _obj
