...
class ResourceCountByInterval(BaseModel):
    """
    ResourceCountByInterval
    """ # noqa: E501
    interval: StrictStr
    resource_count: Union[StrictFloat, StrictInt] = Field(alias="resourceCount")
    __properties: ClassVar[List[str]] = ["interval", "resourceCount"]
