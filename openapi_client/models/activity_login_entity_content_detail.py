...
class ActivityLoginEntityContentDetail(BaseModel):
    """
    ActivityLoginEntityContentDetail
    """ # noqa: E501
    ok: Optional[ActivityLoginEntityDetail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": ActivityLoginEntityDetail.from_dict(obj["ok"]) if obj.get("ok") is not None else None,
