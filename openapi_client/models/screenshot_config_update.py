...
class ScreenshotConfigUpdate(BaseModel):
    """
    ScreenshotConfigUpdate
    """ # noqa: E501
    enable: Optional[StrictBool] = None
    interval: Optional[Int] = None
    __properties: ClassVar[List[str]] = ["enable", "interval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interval": Int.from_dict(obj["interval"]) if obj.get("interval") is not None else None
        })
        return _obj
