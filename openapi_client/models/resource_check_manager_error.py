...
class ResourceCheckManagerError(BaseModel):
    """
    ResourceCheckManagerError
    """ # noqa: E501
    kind: ResourceCheckManagerErrorKind
    resource_name: ResourceName = Field(alias="resourceName")
    total: StrictInt
    usage: StrictInt
    requested: StrictInt
    __properties: ClassVar[List[str]] = ["kind", "resourceName", "total", "usage", "requested"]
