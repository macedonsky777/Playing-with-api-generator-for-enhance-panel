...
class ActivityWebsiteEntityContent(BaseModel):
    """
    ActivityWebsiteEntityContent
    """ # noqa: E501
    id: StrictStr
    detail: ActivityWebsiteEntityContentDetail
    __properties: ClassVar[List[str]] = ["id", "detail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "detail": ActivityWebsiteEntityContentDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None
        })
        return _obj
