...
class LogTimeMetadata(BaseModel):
    """
    How long the request took. It's used with `ok` and `slow` log statuses.
    """ # noqa: E501
    request_time_ms: StrictInt = Field(alias="requestTimeMs")
    __properties: ClassVar[List[str]] = ["requestTimeMs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestTimeMs": obj.get("requestTimeMs")
        })
        return _obj
