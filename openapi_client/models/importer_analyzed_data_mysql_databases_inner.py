...
class ImporterAnalyzedDataMysqlDatabasesInner(BaseModel):
    """
    ImporterAnalyzedDataMysqlDatabasesInner
    """ # noqa: E501
    db_name: StrictStr = Field(alias="dbName")
    sql_init_path: StrictStr = Field(alias="sqlInitPath")
    __properties: ClassVar[List[str]] = ["dbName", "sqlInitPath"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sqlInitPath": obj.get("sqlInitPath")
        })
        return _obj
