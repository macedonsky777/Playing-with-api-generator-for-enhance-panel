...
class LoginMemberships(BaseModel):
    """
    LoginMemberships
    """ # noqa: E501
    memberships: List[LoginMembership]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memberships": [LoginMembership.from_dict(_item) for _item in obj["memberships"]] if obj.get("memberships") is not None else None
        })
        return _obj
