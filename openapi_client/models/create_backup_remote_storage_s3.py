...
class CreateBackupRemoteStorageS3(BaseModel):
    """
    ...
    access_key_secret: StrictStr = Field(alias="accessKeySecret")
    prefix: StrictStr
    __properties: ClassVar[List[str]] = ["purpose", "region", "endpoint", "bucket", "accessKeyId", "accessKeySecret", "prefix"]
