...
class SetupResult(BaseModel):
    ...
    control_panel_website_id: StrictStr = Field(alias="controlPanelWebsiteId")
    __properties: ClassVar[List[str]] = ["loginId", "memberId", "orgId", "serverId", "controlPanelWebsiteId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "controlPanelWebsiteId": obj.get("controlPanelWebsiteId")
        })
        return _obj
