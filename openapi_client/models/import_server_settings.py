...
class ImportServerSettings(BaseModel):
    """
    ...
    ssh_public_key: StrictStr = Field(alias="sshPublicKey")
    ...
    allow_partial_sync: StrictBool = Field(alias="allowPartialSync")
    __properties: ClassVar[List[str]] = ["id", "hostname", "friendlyName", "sshUser", "sshPublicKey", "importType", "authKind", "authUser", "sshPort", "apiPort", "allowPartialSync"]
