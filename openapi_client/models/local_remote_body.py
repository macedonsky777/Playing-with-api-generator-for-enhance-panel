...
class LocalRemoteBody(BaseModel):
    """
    Whether a domain is treated as local or remote by the MTA
    """ # noqa: E501
    local_remote: Optional[LocalRemote] = Field(default=None, alias="localRemote")
    __properties: ClassVar[List[str]] = ["localRemote"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localRemote": obj.get("localRemote")
        })
        return _obj
