...
class UpdateBackupRemoteStorageS3(BaseModel):
    """
    ...
    access_key_secret: Optional[StrictStr] = Field(default=None, alias="accessKeySecret")
    __properties: ClassVar[List[str]] = ["region", "endpoint", "bucket", "accessKeyId", "accessKeySecret"]
