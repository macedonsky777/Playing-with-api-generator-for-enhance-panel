...
class WebsiteOperationValidation(BaseModel):
    """
    WebsiteOperationValidation
    """ # noqa: E501
    operation: WebsiteOperation
    params: Optional[ChangeSubscriptionParams] = None
    __properties: ClassVar[List[str]] = ["operation", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": ChangeSubscriptionParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
