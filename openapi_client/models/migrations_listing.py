...
class MigrationsListing(BaseModel):
    """
    MigrationsListing
    """ # noqa: E501
    items: List[MigrationDetails]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [MigrationDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
