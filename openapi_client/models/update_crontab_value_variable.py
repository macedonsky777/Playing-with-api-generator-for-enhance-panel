...
class UpdateCrontabValueVariable(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variable": UpdateCrontabValueVariableVariable.from_dict(obj["variable"]) if obj.get("variable") is not None else None
        })
        return _obj
