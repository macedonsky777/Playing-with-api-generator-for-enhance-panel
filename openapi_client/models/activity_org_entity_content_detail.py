...
class ActivityOrgEntityContentDetail(BaseModel):
    """
    ActivityOrgEntityContentDetail
    """ # noqa: E501
    ok: Optional[ActivityOrgEntityDetail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": ActivityOrgEntityDetail.from_dict(obj["ok"]) if obj.get("ok") is not None else None,
