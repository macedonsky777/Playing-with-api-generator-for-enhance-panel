...
class ActivityWebsiteEntityContentDetail(BaseModel):
    """
    ActivityWebsiteEntityContentDetail
    """ # noqa: E501
    ok: Optional[ActivityWebsiteEntityDetail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": ActivityWebsiteEntityDetail.from_dict(obj["ok"]) if obj.get("ok") is not None else None,
            "error": HttpError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
