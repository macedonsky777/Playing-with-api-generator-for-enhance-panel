...
class UpdateRewriteChain(BaseModel):
    """
    ...
    """ # noqa: E501
    line_number: Union[StrictFloat, StrictInt] = Field(alias="lineNumber")
    rule: Optional[RewriteChainRule] = None
    conds: Optional[List[RewriteChainCondsInner]] = None
    __properties: ClassVar[List[str]] = ["lineNumber", "rule", "conds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in conds (list)
        _items = []
        if self.conds:
            for _item in self.conds:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rule": RewriteChainRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
            "conds": [RewriteChainCondsInner.from_dict(_item) for _item in obj["conds"]] if obj.get("conds") is not None else None
        })
        return _obj
