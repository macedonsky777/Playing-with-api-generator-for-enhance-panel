...
class DnsSoa(BaseModel):
    ...
    DnsSoa
    """ # noqa: E501
    admin_email: StrictStr = Field(alias="adminEmail")
    name_server: StrictStr = Field(alias="nameServer")
    expire: StrictInt
    refresh: StrictInt
    retry: StrictInt
    ttl: StrictInt = Field(description="In seconds")
    __properties: ClassVar[List[str]] = ["adminEmail", "nameServer", "expire", "refresh", "retry", "ttl"]
