...
class TransferUserAccountReqBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["subscriptionId", "allowPartialSync", "appServerId", "backupServerId", "dbServerId", "emailServerId"]
