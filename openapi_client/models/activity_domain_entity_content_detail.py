...
class ActivityDomainEntityContentDetail(BaseModel):
    """
    ActivityDomainEntityContentDetail
    """ # noqa: E501
    ok: Optional[ActivityDomainEntityDetail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": ActivityDomainEntityDetail.from_dict(obj["ok"]) if obj.get("ok") is not None else None,
