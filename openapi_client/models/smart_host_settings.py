...
class SmartHostSettings(BaseModel):
    """
    SmartHostSettings
    """ # noqa: E501
    host: SmartHostSettingsHost
    creds: SmartHostSettingsCreds
    __properties: ClassVar[List[str]] = ["host", "creds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "host": SmartHostSettingsHost.from_dict(obj["host"]) if obj.get("host") is not None else None,
            "creds": SmartHostSettingsCreds.from_dict(obj["creds"]) if obj.get("creds") is not None else None
        })
        return _obj
