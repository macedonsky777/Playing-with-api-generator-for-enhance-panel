...
class ActivityDomainEntityDetail(BaseModel):
    """
    ...
    mapping_kind: Optional[DomainMappingKind] = Field(default=None, alias="mappingKind")
    __properties: ClassVar[List[str]] = ["name", "orgId", "websiteId", "mappingKind"]
