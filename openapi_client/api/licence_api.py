...
class LicenceApi:
    ...
    def refresh_licence(
        self,
        licence_key: Optional[LicenceKey] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._refresh_licence_serialize(
    ...
    @validate_call
    def refresh_licence_with_http_info(
        self,
        licence_key: Optional[LicenceKey] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def refresh_licence_without_preload_content(
        self,
        licence_key: Optional[LicenceKey] = None,
        _request_timeout: Union[
            None,
    ...
    def _refresh_licence_serialize(
        self,
        licence_key,
        _request_auth,
        _content_type,
