...
class CustomersApi:
    ...
    def get_org_customers(
        ...
        status: Annotated[Optional[StrictStr], Field(description="Filters the customers list by its status.")] = None,
        ...
        :type max_depth: int
        :param status: Filters the customers list by its status.
        :type status: str
        ...
        _param = self._get_org_customers_serialize(
            org_id=org_id,
            offset=offset,
            limit=limit,
            sort_by=sort_by,
    ...
    @validate_call
    def get_org_customers_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The id of the organization.")],
        offset: Annotated[Optional[StrictInt], Field(description="The offset from which to return items.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of items to return.")] = None,
    ...
    @validate_call
    def get_org_customers_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The id of the organization.")],
        offset: Annotated[Optional[StrictInt], Field(description="The offset from which to return items.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of items to return.")] = None,
    ...
    def _get_org_customers_serialize(
        self,
        org_id,
        offset,
        limit,
