...
class MetricsApi:
    ...
    def get_website_metrics(
        ...
        granularity: Annotated[Optional[StrictStr], Field(description="Takes one of `hour`, `day`, defaults to `day`")] = None,
        ...
        :type end: datetime
        :param granularity: Takes one of `hour`, `day`, defaults to `day`
        ...
        _param = self._get_website_metrics_serialize(
            org_id=org_id,
    ...
    @validate_call
    def get_website_metrics_with_http_info(
        self,
        org_id: Annotated[StrictStr, Field(description="The id of the organization.")],
        website_id: Annotated[StrictStr, Field(description="The id of the website.")],
        start: Annotated[Optional[datetime], Field(description="Start datetime UTC.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebsiteMetricsFullListing]:
        """Get website metrics
    ...
    @validate_call
    def get_website_metrics_without_preload_content(
        self,
        org_id: Annotated[StrictStr, Field(description="The id of the organization.")],
        website_id: Annotated[StrictStr, Field(description="The id of the website.")],
        start: Annotated[Optional[datetime], Field(description="Start datetime UTC.")] = None,
    ...
    def _get_website_metrics_serialize(
        self,
        org_id,
        website_id,
        start,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/orgs/{org_id}/websites/{website_id}/metrics',
